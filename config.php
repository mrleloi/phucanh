...
$config['app_key'] = 'fd980e7d8ce54b743466408740b8b245';

// a secret key to be used during encryption
$config['encryption_key'] = '';

// URL running the proxy app
$config['app_url'] = 'http://localhost/proxy/';
...
//$config['index_redirect'] = 'http://localhost/proxy/?url=https://phucanh.vn/';
$config['index_default'] = 'https://phucanh.vn/';
